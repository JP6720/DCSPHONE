  ...
  class DebugStore {
    ...
    checkForUpdate = () => {
      ...
      ;(Platform.OS === 'android'
        ? window
            .fetch(
              'https://play.google.com/store/apps/details?id=com.dcs.phonecall&hl=en',
            )
            .then(res => res.text())
            .then(t =>
        ...
        : window
            .fetch('https://itunes.apple.com/lookup?bundleId=com.dcs.Phonecall')
            .then(res => res.json())
    ...
    openInStore = () => {
      Linking.openURL(
        Platform.OS === 'android'
          ? 'https://play.google.com/store/apps/details?id=com.dcs.phonecall'
